...
## [1 - Concatenando Dados](src/1.concat_dados.py) 🐾
...
## [2 - Repetindo Textos](src/2.repet_txt.py) ✏️
...
## [3 - Operações Matemáticas Simples](src/3.operacoes_matematicas.py) 📐
...
## [4 - Verificando Números Pares e Ímpares](src/4.verificar_numero_impares.py) 🧮
